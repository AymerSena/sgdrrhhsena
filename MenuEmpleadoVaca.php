    ...
    <div id="Menu">
        ...
        <nav id="Logos">
            <ul>
                ...
                <li>
                    <a href="MenuEmpleadoVacaTabla.php"><img class="logo" src="https://1.bp.blogspot.com/-pWbP6N_2-F0/YT5yIQZXEtI/AAAAAAAAAGA/n0-4cvp7gFYTvNkgiiwsFx1FQM-5hRWZACNcBGAsYHQ/s320/IconoCarDesArch.png"></a>
                </li>
