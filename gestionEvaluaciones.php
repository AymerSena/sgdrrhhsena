...
<body>
    ...
    <div class="cuerpo">
        ...
        <button class="rounded"><span class="text-green"><a href="newEvalu.php?idAre=<?php echo $data[0]; ?>">Crear nueva evaluación</a></span></button>
        <button class="rounded"><span class="text-green"><a href="menuJefe.php">Regresar al menú</a></span></button>
        <br>
