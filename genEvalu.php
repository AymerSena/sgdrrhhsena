    ...
    <div class="cuerpo">
        <form action="" method="post">
            ...
            ?>
                ...
                <select name="repu[]" id="" onchange="<?php array_push($arreglo2, $row["CriValorPreg"]);
                                                        array_push($arreglo3, $row["CriCodigo"]); ?>">
            ...
            ?>
            <button class="rounded" name="generar"><span class="text-green">Guardar</span></button>
            <button class="rounded"><span class="text-green"><a href="evaluarEmp.php">Volver</a></span></button>
        </form>
        <?php
