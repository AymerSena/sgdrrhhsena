...
<body>
    ...
    <div class="cuerpo">
        <form action="" method="post">
            ...
            <button class="rounded" name="newCri">Agregar criterio</button>
            <button class="rounded" name="volver">Volver</button>
            <button class="rounded" name="guardar">Guardar y cerrar</button>
        </form>
    </div>
    <?php
    include("pie.php");
