...
?>
            ...
            ?>
            <script>
                alert("El usuario no fue encontrado en el sistema.")
            </script>
<?php
        }
    }
...
<body>
    ...
    <section id="Login">
        ...
        <form method="POST">
            ...
            <button class="rounded" id="boton" type="submit" name="iniciarSesion"><span class="text-green">Iniciar sesión</span></button><br><br>
            <button class="rounded" id="boton1" type="submit" name="resContrasena"><span class="text-green">Restablecer contraseña</span></button><br><br>
        </form>
    </section>
